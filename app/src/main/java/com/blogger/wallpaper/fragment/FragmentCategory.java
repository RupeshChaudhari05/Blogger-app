...
import com.blogger.wallpaper.adapter.AdapterCategory;
import com.blogger.wallpaper.adapter.AdapterListener;
import com.blogger.wallpaper.data.ThisApp;
import com.blogger.wallpaper.databinding.FragmentCategoryBinding;
...
public class FragmentCategory extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (ThisApp.get().getCategories().size() == 0) {
            ...
            Log.d("BBB",ThisApp.get().getCategories().get(0));
...
//        });
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, BLOGGER_URL_PAGES, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                displayApiResult(extractUniqueLabelsNew(response));
            }
