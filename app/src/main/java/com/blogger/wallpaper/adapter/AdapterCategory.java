...
public class AdapterCategory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public class OriginalViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardView category_item;
        public OriginalViewHolder(View v) {
            super(v);
            name = v.findViewById(R.id.name);
           // lytParent = v.findViewById(R.id.category_item);
            img = v.findViewById(R.id.iv_images);
            category_item = v.findViewById(R.id.category_item);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int pos) {
        ...
        if (holder instanceof OriginalViewHolder) {
            ...
            int randomColor = Tools.getRandomColor();

            // Set the background color of the CardView
            v.category_item.setCardBackgroundColor(randomColor);

            v.category_item.setOnClickListener(view -> {
